...
def random_string_generator(chars=string.ascii_lowercase + string.digits):
    return ''.join(str(randint(100, 999)) + '-' + str(randint(100, 999)) + '-' + str(randint(100, 998)))
...
def render_to_pdf(template_src, context_dict={}):
    ...
    result = BytesIO()
    pdf = pisa.pisaDocument(BytesIO(html.encode("utf-8")), dest=result, link_callback=link_callback)
